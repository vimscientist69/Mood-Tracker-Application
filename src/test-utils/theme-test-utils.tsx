...
import { mockTheme, mockDarkTheme, mockNavigationTheme, mockDarkNavigationTheme } from './theme-mock';
...
export const renderWithTheme = (
  ...
  const navTheme = themeType === 'dark' ? mockDarkNavigationTheme : mockNavigationTheme;
