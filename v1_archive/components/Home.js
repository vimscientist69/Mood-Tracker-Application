...
export default function Home({route, navigation}) {
  ...
  useEffect(() => {
    ...
    console.log(
      userData ? userData.currentMonthCalendar : 'No current month calendar',
    );
  }, [userData]);
          ...
          <View
            ...
            <View
              style={{
                ...
                alignItems: 'center',
                backgroundColor:
                  clickedDayObject.value === 0
                    ? '#464646'
                    : clickedDayObject.value === 1
                      ? 'green'
                      : clickedDayObject.value === 2
                        ? 'yellow'
                        : 'red',
              }}>
              <Text
