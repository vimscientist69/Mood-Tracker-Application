...
export default function BottomNavBar(props) {
  ...
  const [updatingCurrentDayEmotion, setUpdatingCurrentDayEmotion] =
    useState(false);
  ...
  async function updateTodaysMood(userEmotionOption) {
    // Removed setReloadPage arg as it's cleaner to use prop
    try {
      if (!user?.id) {
        return;
      }
      ...
      {updatingCurrentDayEmotion ? (
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Image source={require('../assets/signout.png')} style={{}} />
          </TouchableOpacity>
        </View>
      )}
    </SafeAreaView>
